...
import static edu.neu.csye6200.util.GenerateUtil.generateExplodableAPIs;
...
public class ExplodableModel extends AbstractExplodableModel {
  ...
  public static void main(String[] args) {
    ...
    // My class is class edu.neu.csye6200.explodable.UnknownBomb and my hashcode is 885284298
  ...
  public static void demo() {
    ...
    List<ExplodableAPI> data = generateExplodableAPIs();
